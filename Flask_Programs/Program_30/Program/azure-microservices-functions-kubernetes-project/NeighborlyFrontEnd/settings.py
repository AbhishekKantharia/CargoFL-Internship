...
SERVER_HOST = '0.0.0.0'
#SERVER_HOST = 'https://<WEB_APP_NAME>.azurewebsites.net' # Update this for the appropriate front-end website when up
SERVER_PORT = 5000
...
API_URL = "https://[FUNCTION_APP_NAME_GOES_HERE].azurewebsites.net/api"